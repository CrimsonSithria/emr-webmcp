...
export function createOpenmrsMswStore(): OpenmrsMswStore {
  ...
  return {
    ...
    observations: [
      ...
      observation({
        id: 'obs-isolation-write',
        patient: ada,
        name: 'Isolation write probe',
        value: 4.1,
        unit: 'mmol/L',
        observedAt: '2026-08-23T08:05:00.000Z',
        interpretation: 'N',
        category: 'laboratory',
      }),
      observation({
